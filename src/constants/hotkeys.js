...
export const isEnter = (key) => key.return || key.rightArrow
export const isLeave = (key) => key.escape || key.leftArrow
export const isSelectNext = (key) => key.downArrow
export const isSelectPrev = (key) => key.upArrow
